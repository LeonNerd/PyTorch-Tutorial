    ...
    for txt in files:
        ...
        with open(txt)as f:  # 返回一个文件对象
            ...
            for i in range(len(list1)):
                ...
                # print("y", y)
                # print(str(list3[i]))
                f1.write(str(list3[i + 1]) + ' ' + str(x[0]) + " " + str(x[1]) + ' ' + str(y[0]) + ' ' + str(y[1]) + '\n')
        f1.close()
...
def txt_flip():
    # os.getcwd()
    # os.chdir(r'H:/data/cover/bbox/')
    # files = glob('*')
    # os.chdir(r'H:/data/cover/txt_flip/')
    # for txt in files:
    #     isExists = os.path.exists(txt)
    #     if not isExists:
    #         os.mkdir(txt)
    os.getcwd()
    os.chdir(r'H:/data/cover/img/')
    file = glob('*.jpg')
    l = []
    ...
    for txt in files:
        q = 0
        f1 = open('H:/data/cover/txt_flip/' + txt, 'w')
        with open(txt)as f:  # 返回一个文件对象
...
if __name__ == '__main__':
    # pict_left_shift()
    # print('pict_left_shift finish')
    # txt_left_shift()
    # print('txt_left_write finish')
    # pict_right_shift()
    # print('pict_right_shift finish')
    # txt_right_shift()
    # print('txt_right_write finish')
    # pict_flip()
    # print('pict_flip finish')
    txt_flip()
    print('txt_flip_write finish')
