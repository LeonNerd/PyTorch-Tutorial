...
#     sys.exit(1)
#用法：
input_dir = 'H:/data/cover/labels/'  #标签txt所在路径
output_dir = 'H:/data/cover/xml/'  #要输出的xml文件路径
images_dir = 'H:/data/cover/img/'   #txt对应图片所在文件路径
names_file = 'H:/data/cover/0poles.names'    #数据集类名所在文件路径
try:
