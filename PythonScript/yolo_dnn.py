...
input_size = (320, 320)                         #Size of input images
...
#Test only
# def test_detection():
#     classes_file = r"C:\Users\80950\Desktop\cfg\0kouzhao.names"
#     config_file =  r"C:\Users\80950\Desktop\cfg\0kouzhao_tiny.cfg"
#     weights_file = r'C:\Users\80950\Desktop\weights\0kouzhao_tiny.backup'
#     image_folder = r"F:\kouzhao1\alljpg"
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "--source_path",type=str,default=r"F:\kouzhao1\alljpg",
        help="Image path or folder path containing images on which detection will be applied"
    )

    parser.add_argument(
        "--config_file",type=str,default=r"C:\Users\80950\Desktop\cfg\yolov3-tiny-prn2.cfg",
        help="YOLO config file"
    )

    parser.add_argument(
        "--weights_file",type=str,default=r'C:\Users\80950\Desktop\weights\yolov3-tiny-prn2_last.weights',
        help="YOLO weights file"
    )

    parser.add_argument(
        "--class_file",type=str,default=r"C:\Users\80950\Desktop\cfg\0kouzhao.names",
