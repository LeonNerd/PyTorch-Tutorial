...
void validate_detector_recall(char *cfgfile, char *weightfile)
{
    ...
    list *plist = get_paths("/home/hdsx/wsj/darknet/test.txt");
    char **paths = (char **)list_to_array(plist);
...
void test_detector(char *datacfg, char *cfgfile, char *weightfile, char *filename, float thresh, float hier_thresh, char *outfile, int fullscreen)
{
    ...
    while(1){
        ...
        //resize_network(net, sized.w, sized.h);
            ...
            int m = plist->size;
            if(access("/home/hdsx/wsj/darknet/data/out",0)==-1)//"/home/FENGsl/darknet/data"修改成自己的路径
            {
              if (mkdir("/home/hdsx/wsj/darknet/data/out",0777))//"/home/FENGsl/darknet/data"修改成自己的路径
               {
        ...
        if(outfile){
            save_image(im, outfile);
             ...
             char b[2048];
            sprintf(b,"/home/hdsx/wsj/darknet/data/out/%s",GetFilename(path));//"/home/hdsx/wsj/darknet/data/"修改成自己的路径
