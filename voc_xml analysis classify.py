...
ann_filepath = 'H:/VOCdevkit/VOC2007/Annotations/'
img_filepath = 'H:/VOCdevkit/VOC2007/JPEGImages/'
img_savepath = 'H:/VOCdevkit/VOC2007/NewJPEGImages/'
ann_savepath = 'H:/VOCdevkit/VOC2007/NewAnnotations/'
...
for file in os.listdir(ann_filepath):
    ...
    classes1 = '\t\t<name>cat</name>\n'
    classes2 = '\t\t<name>dog</name>\n'
